---
title: '【译】如何应对CNN中的过拟合问题'
date: 2017-08-13 01:06:18
description: 什么是 CNN 以及如何解决欠拟合和过拟合问题
tags: 
- 深度学习
- 神经网络
- CNN
- 过拟合
categories: 深度学习
thumbnail: https://user-gold-cdn.xitu.io/2017/8/13/a079338e77693bd70e65beb5a06da1c1?imageView2/1/w/1200/h/700/q/85/interlace/1
---
...
![数据增强（Data augmentation）](https://ws2.sinaimg.cn/large/006tKfTcly1fs3uyowcrkj317z0gcwns.jpg)
...
在每个卷积层（或多个）之后，我们通常就得到了最大池化（Max pooling）层。这个层会减少图像中的像素数量。例如，我们可以从图像中取出一个正方形然后用这个正方形里面像素的最大值代替这个正方形。
 ![最大池化](https://ws4.sinaimg.cn/large/006tKfTcly1fs3uyr8jl1j30lv0a80tc.jpg)
...
![原始图像](https://ws3.sinaimg.cn/large/006tKfTcly1fs3uyt43x0j30ed098758.jpg)

现在我们来看看执行数据增强后的图像。所有的“猫”仍然能够被清楚地识别出来。

 
![数据增强之后的图像](https://ws1.sinaimg.cn/large/006tKfTcly1fs3uyuige2j318g0f8jx9.jpg)
...
![](https://ws1.sinaimg.cn/large/006tKfTcly1fs3uyvxxh8j30t00eg0w8.jpg)
...
如果你喜欢这篇文章，欢迎推荐它以便其他人可以看到它。您还可以按照此配置文件跟上我在 fast AI 课程中的进度。到时候见！
